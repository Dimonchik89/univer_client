...
interface LoginFormProps {
    useHandleForm: () => UseMutationResult<
        any,
        Error,
        {
            email: string;
...
const LoginForm = ({ useHandleForm, title, buttonTitle }: LoginFormProps) => {
    ...
    return (
        <>
            <h2 className="text-2xl font-bold text-center text-green-600 mb-4 capitalize">
                {title}
            </h2>
            <Formik
            ...
            <button
                ...
                onClick={() =>
                    (window.location.href = `${process.env.NEXT_PUBLIC_BASE_URL}/google/login`)
                }
            >
